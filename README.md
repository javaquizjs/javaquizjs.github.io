...
- **Hero section** with live link and shield badges (question count, categories, license)
- **Overview** explaining the single-file, zero-dependency philosophy
- **Features** organized into 6 groups — quiz engine, timer, persistence, achievements, celebrations, results
- **Categories table** — all 20 categories in a compact two-column layout
- **Getting started** — 3 options (online, local file, local server)
- **Project structure** — highlights the single-file architecture
- **Settings table** — all configurable options with defaults
- **Awards table** — all 14 achievements with unlock requirements
- **Technical details** — key architectural decisions
- **Contributing guide** — includes the exact JSON schema for adding questions
- **License** — MIT (name only, no version as requested)
- **Links** — live app, repository, and issues using the provided GitHub URL
